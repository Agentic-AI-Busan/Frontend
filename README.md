...
|                                                                                 프로필                                                                                 | 이름/기여 내용                                                                                           |
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------- |
| <a href="[성수립_GitHub_프로필_URL]"><img src="./src/assets/seongsurib_profile.jpg" alt="성수립 프로필" width="120"/></a><br/>**[성수립]([성수립_GitHub_프로필_URL])** | **&lt;프로젝트 기여&gt;**<br/>• 서비스 기획 및 디자인 총괄<br/>• 프론트엔드 개발 총괄<br/>               |
| <a href="[이여녕_GitHub_프로필_URL]"><img src="./src/assets/leeenyeong_profile.png" alt="이어녕 프로필" width="120"/></a><br/>**[이여녕]([이여녕_GitHub_프로필_URL])** | **&lt;프로젝트 기여&gt;**<br/>• 질문 페이지 개발<br/>• 로그인/회원가입 페이지 개발<br/>• 마이페이지 개발 |
