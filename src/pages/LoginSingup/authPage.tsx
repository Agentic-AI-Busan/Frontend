...
const SwitchPanel = styled.div<{ $isLogin: boolean }>`
  ...
  @media (max-width: 700px) {
    clip-path: ${(props) =>
      props.$isLogin ? "inset(0px 0px 0px 100%)" : "inset(0px 100% 0px 0px)"};
  }
`
...
const AuthPage: React.FC = () => {
  ...
  const toggleMode = () => {
    setIsLogin(!isLogin)
    // Reset signup step when toggling mode
    setSignupStep(1)
    setUsernameError("")
  ...
  // Render only the active login or signup form
  ...
  // Render only the active signup form step
            ...
            {signupStep === 2 && (
              <div className={isExiting ? "exiting" : ""}>
                ...
                <InputGroup style={{ marginBottom: 0 }}>
                  ...
                  {isPasswordMatch && !passwordError && <PasswordMessage style={{ color: '#27ae60' }}>비밀번호가 일치합니다.</PasswordMessage>}
                </InputGroup>
            ...
            {signupStep === 3 && (
              <div className={isExiting ? "exiting" : ""}>
                ...
                <InputGroup style={{ marginBottom: 0 }}>
                  ...
                  <PhoneInputGroup>
                    <FormSelect name="phonePrefix" value={signupForm.phonePrefix} onChange={handleSignupChange} style={{ width: '30%' }}>
      ...
      <SignContainer>
        ...
        <SwitchPanel $isLogin={isLogin}>
          ...
          <Group>
            <TextGroup>
              {isLogin ? (
                // Signup Info (Shows when on login page)
                ...
                // Login Info (Shows when on signup page)
